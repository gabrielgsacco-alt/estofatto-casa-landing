...
export const QualificationForm: React.FC = () => {
  ...
  const { register, handleSubmit, formState: { errors }, reset, watch, setValue } = useForm<QualificationFormData>({
    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-2">
            <Label htmlFor="email" className="text-xs tracking-widest uppercase font-semibold text-foreground">
              Email *
            </Label>
            <Input
              id="email"
          ...
          <div className="space-y-2">
            <Label htmlFor="telefone" className="text-xs tracking-widest uppercase font-semibold text-foreground">
              Telefone / WhatsApp *
            </Label>
            <Input
              id="telefone"
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={(value) => setValue('investimento', value)}>
              ...
              <SelectContent className="bg-card border-border">
                ...
                <SelectItem value="10mil-20mil">R$ 10.000 - R$ 20.000</SelectItem>
          ...
          <div className="space-y-2 md:col-span-2">
            <Label htmlFor="fase" className="text-xs tracking-widest uppercase font-semibold text-foreground">
              Fase do Projeto *
            </Label>
            <RadioGroup onValueChange={(value) => setValue('fase', value)}>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="planejamento" id="planejamento" />
                <Label htmlFor="planejamento" className="font-normal cursor-pointer">Planejamento inicial</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="em-andamento" id="em-andamento" />
                <Label htmlFor="em-andamento" className="font-normal cursor-pointer">Projeto em andamento</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="finalizacao" id="finalizacao" />
                <Label htmlFor="finalizacao" className="font-normal cursor-pointer">Finalização / Pronto para comprar</Label>
              </div>
            </RadioGroup>
            {errors.fase && <p className="text-xs text-destructive">{errors.fase.message}</p>}
          </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-background border border-border p-8 max-w-sm text-center space-y-4 animate-scale-in">
            ...
            <p className="text-sm text-foreground font-medium">
              Seu formulário foi enviado com sucesso. Você será redirecionado para o WhatsApp em instantes.
            </p>
